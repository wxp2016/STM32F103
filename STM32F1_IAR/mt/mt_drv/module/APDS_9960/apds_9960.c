...
//AmbientLightSensor(interrupt)
extern uint16_t ambient_light;
extern uint16_t red_light;
extern uint16_t green_light;
extern uint16_t blue_light;
extern uint16_t thresholdLow;
extern uint16_t thresholdHigh;


//ProximitySensor
extern uint8_t proximity_data;

extern int isr_flag;//中断标志位
