...
VCC         3.3V
GND         电源地
SCL         SPI_CLK(IIC_SCL)        P22
SDA         SPI_MOSI(IIC_SDA)       P23
SD0/SA0     SPI_MISO(IIC_SA0)       P24
CS          SPI(0=SPI Mode)         P25
INT1        中断1                   P26
INT2        中断2                   P27
ADC1        模拟输入1        
ADC2        模拟输入2    
...
status_t LSM6DSL_ACC_GYRO_ReadReg(void *handle, u8_t Reg, u8_t* Data, u16_t len) 
{
  ...
  MT_SPI_Read(handle,Reg,Data,len);
  //LSM6DSL_ReadReg(handle,Reg,Data,len);
  return MEMS_SUCCESS;                                           
}
...
status_t LSM6DSL_ACC_GYRO_WriteReg(void *handle, u8_t Reg, u8_t *Data, u16_t len) 
{
  ...
  //LSM6DSL_WriteReg(handle,Reg,Data,len);
  MT_SPI_Write(handle,Reg,Data,len);
  return MEMS_SUCCESS;                                          
}
